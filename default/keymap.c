...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    if (keycode == KC_ESCAPE && record->event.pressed && is_oneshot_layer_active()) {
...
td_state_t cur_dance(tap_dance_state_t *state) {
    if (state->count == 1) {
        ...
        // Second press is still held down: this is a "tap-then-hold", not a clean double tap.
...
const uint16_t PROGMEM keymaps[DYNAMIC_KEYMAP_LAYER_COUNT][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [FKEYS] = LAYOUT(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,

                     KC_F4, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_F3, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_F2, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_F1, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
