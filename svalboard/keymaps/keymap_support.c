...
// Set from keymap.c's layer_state_set_user; when true, drop all incoming
// pointer movement instead of forwarding it as a mouse report or letting it
// trigger mouse_mode().
extern bool pointer_movement_locked;
